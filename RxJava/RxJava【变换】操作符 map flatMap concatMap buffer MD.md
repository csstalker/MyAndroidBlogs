...
- [变换操作符](#变换操作符)
	...
	- [buffer](#buffer)
		...
		- [buffer(count, skip)](#buffer(count,-skip))
		- [buffer(timespan, unit)](#buffer(timespan,-unit))
		- [buffer(timespan, unit, count)](#buffer(timespan,-unit,-count))
	- [scan](#scan)
	- [groupBy](#groupBy)
	- [window](#window)
		- [window(count)](#window(count))
		- [window(count, skip)](#window(count,-skip))
		- [window(timespan, unit)](#window(timespan,-unit))
		- [window(timespan, unit, count)](#window(timespan,-unit,-count))
