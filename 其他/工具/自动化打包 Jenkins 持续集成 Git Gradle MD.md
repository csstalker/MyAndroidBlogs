...
![](index_files/1a292c88-d2e9-4913-b155-bc1a4a341074.png)    
...
![](index_files/ee76eaa0-c0d0-4896-bd73-d90e0cc9cece.png)    
  
通过上图的下拉列表的选择，可以看到支持的各种参数类型，例如我们选择`选项参数`来提供指定环境的选择。    
![](index_files/2a8ff5d4-ae31-4b70-bab4-97503507c4c0.png)    
  
> PS:有些配置如果我们不知道怎么填，可以点击后面的蓝色问号按钮，可以显示提示，再点一下就会关闭提示。  
  
## 工作空间配置   
配置完上一步后，点击右下角的“高级”按钮，配置我们的工作空间。以后Android项目代码以及打出的包都会在这个路径下。     
![](index_files/0d0228a3-7526-4688-bf42-840f628c2ca1.png)    
...
![](index_files/67935ad8-59c3-4c5a-b233-487815f52e30.png)    
  
然后点击`Add`添加`Credentials`(证书)，有以下几种方式：    
![](index_files/0b9ad93c-7832-4254-be80-0fe76f03ae9e.png)    
  
我们一般选择`用户名+密码` 或`SSH`方式，配置后就可以自动验证了。    
  
## 构建触发器  
触发器是决定什么时候触发构建，可以设置为定时构建：    
![](index_files/f8733900-a250-48cf-85e2-88c2d6d74ba9.png)    
  
还可以设置定时检查代码更新，有更新则编译，否则不编译：    
![](index_files/066c093d-fbe9-4131-bd0f-50ba091cdd15.png)    
...
![](index_files/1cd8268d-7d43-424d-a644-22aece8977f5.png)    
...
![](index_files/9a779e5d-9558-4ebd-973f-4d6f131d82ad.png)    
...
![](index_files/f2962c24-1ade-48ad-a6a4-1c88924e9efc.png)    
...
在打包完成后，可以显示我们存档的文件：  
![](index_files/999ef51c-8c80-47c7-895b-248c860a44d4.png)    
  
# 打包  
一切配置完成后，点击最右边的按钮即可通过jenkins进行打包：  
![](index_files/13238a7c-7d75-45c5-96e6-91e0b5bff7bd.png)  
  
打包过程：  
![](index_files/3238aefe-ba47-4696-8669-a1cf6b812a4a.png)  
